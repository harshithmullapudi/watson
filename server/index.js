...
const collectionMap = {
  'Test': {
    collection_id: '43f5c7be-e5f3-43a6-8deb-99d3ffb94e97',
  },
  'Test 1': {
    collection_id: '4457a21e-cc8b-47bf-ab5d-7fbeb3ba248e'
  },
}
...
function createServer() {
  ...
  server.get('/api/search', (req, res) => {
    const { query, collection, filters, count, returnPassages, sort, queryType } = req.query;
    console.log(collection)
    var params = {};

    console.log('In /api/search: query = ' + query);
    console.log('In collection : ' + collection);
    const collectionData = collectionMap[collection];
    ...
    queryBuilder.setCollectionId(collectionData.collection_id);
