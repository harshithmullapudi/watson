...
class Main extends React.Component {
   ...
   * discovery service.
   */
  fetchData(query, clearFilters, collection) {
    ...
    scrollToMain();
    history.pushState({}, {}, `/${collection}/${searchQuery.replace(/ /g, '+')}`);
