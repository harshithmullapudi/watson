...
import { Header, Grid, Input, Checkbox, Dropdown } from 'semantic-ui-react';
...
export default class SearchField extends React.Component {
  ...
  render() {
    const { queryType, returnPassages, limitResults, collection } = this.state;
    ...
    return (
      <Grid className='search-field-grid'>
        <Grid.Column width={12} verticalAlign='middle' textAlign='center'>
          ...
          <Dropdown placeholder='Collection' search selection options={[{
            key: 1,
            text: 'Test',
            value: 'Test',
          }, {
